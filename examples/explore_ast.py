...
# can pass it.
#
print ("\033[1;5;32;45;1mast.show()\033[0m")
ast.show()
...
#
print ("\033[1;5;32;45;1mast.ext[2].show()\033[0m")
ast.ext[2].show()
...
# ParamList node
print ("\033[1;5;32;45;1mfunction_decl.type.show()\033[0m")
function_decl.type.show()
print ("\033[1;5;32;45;1mfunction_decl.type.args.show()\033[0m")
function_decl.type.args.show()

# The following displays the name and type of each argument:
#
print ("\033[1;5;32;45;1mvisit the ParamList\033[0m")
...
# body
#
print ("\033[1;5;32;45;1mvisit the body\033[0m")
...
#
print ("\033[1;5;32;45;1mvisit the statement of for body\033[0m")
...
#
print ("\033[1;5;32;45;1mvisit the statement in for loop\033[0m")
...
# The condition:
#
print ("\033[1;5;32;45;1mwhile condition node\033[0m")
...
#
print ("\033[1;5;32;45;1moprator\033[0m")
print(while_cond.op)
print ("\033[1;5;32;45;1mvalue of oprator\033[0m")
